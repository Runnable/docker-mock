...
var getImageTar = series(
  mw.combine,
  mw.findImage,
  mw.saveImage);
app.get('/images/:repository/get', getImageTar);
app.get('/images/:namespace/:repository/get', getImageTar);
app.get('/images/:registry/:namespace/:repository/get', getImageTar);

app.post('/images/load', mw.loadImage);
