...
var middlewares = module.exports = {
  ...
  respondImages: function (req, res) {
    var data = Object.keys(images).map(function (id) {
      ...
      if (images[id].container_config) {
        // have to rename some things
        images[id].Id = images[id].id;
        images[id].Created = images[id].created;
        images[id].RepoTags = images[id].RepoTags || [];
        return images[id];
      }
