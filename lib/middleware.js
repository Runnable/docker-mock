...
module.exports = {
  ...
  pullRepo: function (req, res, next) {
    if (!req.query.fromImage || !req.query.tag) {
      res.set('Connection', 'close');
      return res.send(404);
    }
    var repo = req.query.fromImage +':'+ req.query.tag;
    res.json(200, { 'stream': 'Successfully pulled' + repo });
  },
